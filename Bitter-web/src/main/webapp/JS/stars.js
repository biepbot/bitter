...
var particleCount = 100,
	...
	lineWidth = 1,
	linkSpeed = 5, // distance a link travels in 1 frame
	linkChance = 3 + 0.5 * linkSpeed, // chance per frame of link, higher = smaller chance
	linkLengthMin = 5, // min linked vertices
	linkLengthMax = 10, // max linked vertices
	linkOpacity = 0.25; // number between 0 & 1
	linkFade = 60 / linkSpeed, // link fade-out frames
	glareAngle = -60,
...
function init() {
	...
	//})();
		...
		return function( callback ){
                            window.setTimeout(callback, 1000 * linkSpeed / 60);
			};
	})();
